...
// zero. Isolado num módulo próprio (carregado via React.lazy em App.tsx) —
// o import de 'tldraw' roda código de detecção de ambiente (CSS.supports)
// assim que o módulo é avaliado, o que quebrava TODOS os testes Vitest que
// importavam App.tsx (jsdom não implementa CSS.supports). Como módulo
// separado, só é avaliado quando o usuário realmente abre um quadro.
...
import { WhiteboardDef } from '../../types';

export function WhiteboardCanvas({ whiteboard, onClose }: { whiteboard: WhiteboardDef; onClose: () => void }) {
